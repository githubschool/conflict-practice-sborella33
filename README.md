...
This repository is also being used as a part of GitHub training, to practice Git and GitHub. This repository also has some baked in merge conflicts for practice. 
